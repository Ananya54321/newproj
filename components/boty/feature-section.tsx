...
const features = [
  {
    ...
    description: "Instant emergency reporting for animal rescue"
  },
  {
    icon: Stethoscope,
    title: "Expert Veterinary",
    description: "Access to professional vet consultations"
  },
  {
    icon: ShoppingBag,
    title: "Pet Marketplace",
    description: "A curated space for all pet essentials"
  },
  {
    icon: Users,
    title: "Community Driven",
    description: "Peer-to-peer support for pet owners"
  }
]
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xl text-foreground mb-2 font-medium">
                    Unified <span className="">Pet Care</span>
                  </h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    A single platform for marketplace, community, and emergency rescue services.
                  </p>
                </div>
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <p className={`text-lg text-muted-foreground leading-relaxed mb-10 max-w-md ${headerVisible ? 'animate-blur-in opacity-0' : 'opacity-0'}`} style={headerVisible ? { animationDelay: '0.6s', animationFillMode: 'forwards' } : {}}>
              We believe animal welfare should be a coordinated effort, not a fragmented struggle. 
              Our platform bridges the gap between pet owners, vets, and rescuers.
            </p>
