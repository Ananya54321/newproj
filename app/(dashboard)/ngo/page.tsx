...
import { Plus, Loader2, Heart, FileText } from 'lucide-react'
import { useAuth } from '@/hooks/use-auth'
import { getNGOById, getNGOUpdates, getNGODonations, deleteNGOUpdate, formatDonationAmount } from '@/lib/ngo/service'
...
export default function NgoDashboardPage() {
  ...
  useEffect(() => {
    if (!loading && profile && profile.role !== 'ngo') {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="font-serif text-3xl font-bold text-foreground mb-1.5">NGO Dashboard</h1>
                <p className="text-muted-foreground text-sm max-w-lg">Manage your organization&apos;s presence and engage with donors.</p>
              </div>
            </div>
            <Button asChild size="sm">
              <Link href="/ngo/updates/new" className="gap-1.5">
      ...
      <div>
        ...
        {updates.length === 0 ? (
          <div className="py-12 text-center bg-card rounded-2xl boty-shadow">
            ...
            <Button asChild size="sm">
              <Link href="/ngo/updates/new">Post First Update</Link>
            </Button>
          </div>
        ) : (
      ...
      {donations.length > 0 && (
        <div>
          <h2 className="font-semibold text-foreground mb-3">Recent Donations</h2>
